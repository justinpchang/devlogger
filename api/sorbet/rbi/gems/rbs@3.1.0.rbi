...
class RBS::AST::Declarations::AliasDecl < ::RBS::AST::Declarations::Base
  ...
  # source://rbs//lib/rbs/ast/declarations.rb#393
  def ==(other); end
  ...
  # source://rbs//lib/rbs/ast/declarations.rb#401
  def hash; end
...
class RBS::AST::Declarations::ClassAlias < ::RBS::AST::Declarations::AliasDecl
  # source://rbs//lib/rbs/ast/declarations.rb#407
  def to_json(state = T.unsafe(nil)); end
end
...
class RBS::Collection::Config::Lockfile
  ...
  #
  # source://rbs//lib/rbs/collection/config/lockfile.rb#98
  def check_rbs_availability!; end

  # source://rbs//lib/rbs/collection/config/lockfile.rb#29
  def each_source(&block); end

  # source://rbs//lib/rbs/collection/config/lockfile.rb#19
  def fullpath; end

  # source://rbs//lib/rbs/collection/config/lockfile.rb#23
  ...
  # source://rbs//lib/rbs/collection/config/lockfile.rb#90
  ...
  # source://rbs//lib/rbs/collection/config/lockfile.rb#39
  def to_lockfile; end

  class << self
    # source://rbs//lib/rbs/collection/config/lockfile.rb#55
...
class RBS::Collection::Config::LockfileGenerator
  ...
  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#60
  def generate; end
  ...
  def assign_gem(name:, version:, src_data:, ignored_gems:, skip: T.unsafe(nil)); end

  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#143
  def assign_stdlib(name:, from_gem:); end

  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#175
  def find_best_version(version:, versions:); end

  # source://rbs//lib/rbs/collection/config/lockfile_generator.rb#169
...
class RBS::Collection::Sources::Git
  ...
  # source://rbs//lib/rbs/collection/sources/git.rb#226
  def load_metadata(dir:); end

  # source://rbs//lib/rbs/collection/sources/git.rb#71
  def manifest_of(name, version); end

  # source://rbs//lib/rbs/collection/sources/git.rb#210
  ...
  # source://rbs//lib/rbs/collection/sources/git.rb#175
  ...
  # source://rbs//lib/rbs/collection/sources/git.rb#111
  def to_lockfile; end

  # source://rbs//lib/rbs/collection/sources/git.rb#36
  def versions(name); end

  # source://rbs//lib/rbs/collection/sources/git.rb#218
  def write_metadata(dir:, name:, version:); end

  private

  # source://rbs//lib/rbs/collection/sources/git.rb#85
  def _install(dest:, name:, version:); end

  # @return [Boolean]
  #
  # source://rbs//lib/rbs/collection/sources/git.rb#186
  def commit_hash?; end

  # source://rbs//lib/rbs/collection/sources/git.rb#97
  def cp_r(src, dest); end

  # source://rbs//lib/rbs/collection/sources/git.rb#121
  def format_config_entry(name, version); end

  # source://rbs//lib/rbs/collection/sources/git.rb#171
  def gem_repo_dir; end

  # source://rbs//lib/rbs/collection/sources/git.rb#232
  def gems_versions; end

  # source://rbs//lib/rbs/collection/sources/git.rb#190
  def git(*cmd, **opt); end

  # @return [Boolean]
  #
  # source://rbs//lib/rbs/collection/sources/git.rb#194
  def git?(*cmd, **opt); end
  ...
  # source://rbs//lib/rbs/collection/sources/git.rb#128
  def setup!; end

  # source://rbs//lib/rbs/collection/sources/git.rb#200
  def sh!(*cmd, **opt); end
end
...
class RBS::Collection::Sources::Local
  ...
  # source://rbs//lib/rbs/collection/sources/local.rb#62
  def manifest_of(name, version); end
  ...
  # source://rbs//lib/rbs/collection/sources/local.rb#70
  def to_lockfile; end
  ...
  # source://rbs//lib/rbs/collection/sources/local.rb#57
...
class RBS::Collection::Sources::Stdlib
  ...
  # source://rbs//lib/rbs/collection/sources/stdlib.rb#34
  def to_lockfile; end
  ...
  # source://rbs//lib/rbs/collection/sources/stdlib.rb#40
...
# source://rbs//lib/rbs/errors.rb#499
...
class RBS::DefinitionBuilder
  ...
  # source://rbs//lib/rbs/definition_builder.rb#590
  ...
  # source://rbs//lib/rbs/definition_builder.rb#751
  def expand_alias(type_name); end

  # source://rbs//lib/rbs/definition_builder.rb#755
  def expand_alias1(type_name); end

  # source://rbs//lib/rbs/definition_builder.rb#761
  def expand_alias2(type_name, args); end

  # source://rbs//lib/rbs/definition_builder.rb#532
  def import_methods(definition, module_name, module_methods, interfaces_methods, subst); end

  # source://rbs//lib/rbs/definition_builder.rb#524
  ...
  # source://rbs//lib/rbs/definition_builder.rb#398
  ...
  # source://rbs//lib/rbs/definition_builder.rb#428
  ...
  # source://rbs//lib/rbs/definition_builder.rb#784
  def update(env:, except:, ancestor_builder:); end

  # source://rbs//lib/rbs/definition_builder.rb#418
  def validate_params_with(type_params, result:); end

  # @raise [NoTypeFoundError]
  #
  # source://rbs//lib/rbs/definition_builder.rb#813
...
class RBS::DefinitionBuilder::AncestorBuilder
  ...
  # source://rbs//lib/rbs/definition_builder/ancestor_builder.rb#564
  def fill_ancestor_source(ancestor, name:, source:, &block); end

  # source://rbs//lib/rbs/definition_builder/ancestor_builder.rb#408
  ...
  # source://rbs//lib/rbs/definition_builder/ancestor_builder.rb#531
  ...
  # source://rbs//lib/rbs/definition_builder/ancestor_builder.rb#388
  ...
  # source://rbs//lib/rbs/definition_builder/ancestor_builder.rb#337
  ...
  # source://rbs//lib/rbs/definition_builder/ancestor_builder.rb#318
  ...
  # source://rbs//lib/rbs/definition_builder/ancestor_builder.rb#264
  ...
  # source://rbs//lib/rbs/definition_builder/ancestor_builder.rb#481
...
# source://rbs//lib/rbs/errors.rb#379
class RBS::DuplicatedDeclarationError < ::RBS::LoadingError
  ...
  # Returns the value of attribute name.
  #
  # source://rbs//lib/rbs/errors.rb#380
  def name; end
end
...
class RBS::DuplicatedInterfaceMethodDefinitionError < ::RBS::DefinitionError
  ...
  #
  # source://rbs//lib/rbs/errors.rb#284
  ...
  # Returns the value of attribute member.
  #
  # source://rbs//lib/rbs/errors.rb#282
  def member; end
  ...
  # Returns the value of attribute type.
  #
  # source://rbs//lib/rbs/errors.rb#280
  def type; end
...
class RBS::DuplicatedMethodDefinitionError < ::RBS::DefinitionError
  ...
  # source://rbs//lib/rbs/errors.rb#268
  def location; end

  # Returns the value of attribute members.
  #
  # source://rbs//lib/rbs/errors.rb#241
  def members; end

  # Returns the value of attribute method_name.
  #
  # source://rbs//lib/rbs/errors.rb#240
  def method_name; end
  ...
  # source://rbs//lib/rbs/errors.rb#264
  def type_name; end
end
...
class RBS::Environment
  ...
  # source://rbs//lib/rbs/environment.rb#327
  def insert_decl(decl, outer:, namespace:); end

  # source://rbs//lib/rbs/environment.rb#752
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/environment.rb#282
  def normalize_module_name?(name); end
  ...
  # source://rbs//lib/rbs/environment.rb#627
  def resolve_member(resolver, map, member, context:); end

  # source://rbs//lib/rbs/environment.rb#727
  def resolve_method_type(resolver, map, type, context:); end

  # source://rbs//lib/rbs/environment.rb#443
  def resolve_type_names(only: T.unsafe(nil)); end

  # source://rbs//lib/rbs/environment.rb#735
  ...
  # source://rbs//lib/rbs/environment.rb#761
  def unload(buffers); end

  # source://rbs//lib/rbs/environment.rb#437
...
class RBS::EnvironmentLoader
  ...
  # source://rbs//lib/rbs/environment_loader.rb#111
  def each_dir; end

  # source://rbs//lib/rbs/environment_loader.rb#134
  def each_signature; end

  # @return [Boolean]
  #
  # source://rbs//lib/rbs/environment_loader.rb#89
  def has_library?(library:, version:); end

  # Returns the value of attribute libs.
  #
  # source://rbs//lib/rbs/environment_loader.rb#22
  def libs; end

  # source://rbs//lib/rbs/environment_loader.rb#97
  def load(env:); end
  ...
  # source://rbs//lib/rbs/environment_loader.rb#64
  def resolve_dependencies(library:, version:); end

  class << self
    # source://rbs//lib/rbs/environment_loader.rb#27
    def gem_sig_path(name, version); end
  end
end
...
class RBS::GenericParameterMismatchError < ::RBS::LoadingError
  ...
  # Returns the value of attribute decl.
  #
  # source://rbs//lib/rbs/errors.rb#370
  def decl; end
...
# source://rbs//lib/rbs/errors.rb#172
class RBS::InheritModuleError < ::RBS::DefinitionError
  ...
  # source://rbs//lib/rbs/errors.rb#183
  def location; end
...
# source://rbs//lib/rbs/errors.rb#339
...
class RBS::InvalidTypeApplicationError < ::RBS::DefinitionError
  ...
  #
  # source://rbs//lib/rbs/errors.rb#80
  ...
  # Returns the value of attribute location.
  #
  # source://rbs//lib/rbs/errors.rb#78
  def location; end

  # Returns the value of attribute params.
  #
  # source://rbs//lib/rbs/errors.rb#77
  def params; end

  # Returns the value of attribute type_name.
  #
  # source://rbs//lib/rbs/errors.rb#75
  def type_name; end
...
class RBS::InvalidVarianceAnnotationError < ::RBS::DefinitionError
  ...
  #
  # source://rbs//lib/rbs/errors.rb#399
  def initialize(type_name:, param:, location:); end

  # Returns the value of attribute location.
  #
  # source://rbs//lib/rbs/errors.rb#397
  def location; end
...
class RBS::NoMixinFoundError < ::RBS::DefinitionError
  ...
  # source://rbs//lib/rbs/errors.rb#227
  def location; end

  # Returns the value of attribute member.
  #
  # source://rbs//lib/rbs/errors.rb#218
  def member; end
...
class RBS::NoSelfTypeFoundError < ::RBS::DefinitionError
  ...
  #
  # source://rbs//lib/rbs/errors.rb#200
  ...
  # Returns the value of attribute type_name.
  #
  # source://rbs//lib/rbs/errors.rb#197
  def type_name; end
...
class RBS::NoSuperclassFoundError < ::RBS::DefinitionError
  ...
  class << self
    # source://rbs//lib/rbs/errors.rb#163
    def check!(type_name, env:, location:); end
  end
end

# source://rbs//lib/rbs/errors.rb#133
class RBS::NoTypeFoundError < ::RBS::DefinitionError
  ...
  # Returns the value of attribute type_name.
  #
  # source://rbs//lib/rbs/errors.rb#136
  def type_name; end
...
class RBS::NonregularTypeAliasError < ::RBS::BaseError
  ...
  #
  # source://rbs//lib/rbs/errors.rb#491
  ...
  # Returns the value of attribute location.
  #
  # source://rbs//lib/rbs/errors.rb#489
  def location; end
end
...
class RBS::Parser
  class << self
    ...
    # source://rbs//lib/rbs/parser_aux.rb#22
...
# source://rbs//lib/rbs/errors.rb#44
class RBS::ParsingError < ::RBS::BaseError
  ...
  #
  # source://rbs//lib/rbs/errors.rb#48
  def error_message; end

  # source://rbs//lib/rbs/errors.rb#59
  def error_value; end

  # Returns the value of attribute location.
  #
  # source://rbs//lib/rbs/errors.rb#47
  def location; end

  # source://rbs//lib/rbs/errors.rb#66
  def token_str; end
...
module RBS::Prototype::Helpers
  ...
  # source://rbs//lib/rbs/prototype/helpers.rb#125
  def untyped; end
end
...
class RBS::Prototype::RB
  ...
  # source://rbs//lib/rbs/prototype/rb.rb#511
  def block_type(node); end

  # source://rbs//lib/rbs/prototype/rb.rb#491
  def body_type(node); end

  # source://rbs//lib/rbs/prototype/rb.rb#410
  def const_to_name(node, context:); end

  # source://rbs//lib/rbs/prototype/rb.rb#391
  def const_to_name!(node); end

  # source://rbs//lib/rbs/prototype/rb.rb#689
  def current_accessibility(decls, index = T.unsafe(nil)); end

  # source://rbs//lib/rbs/prototype/rb.rb#41
  def decls; end

  # source://rbs//lib/rbs/prototype/rb.rb#729
  def find_def_index_by_name(decls, name); end

  # source://rbs//lib/rbs/prototype/rb.rb#486
  def function_return_type_from_body(node); end

  # source://rbs//lib/rbs/prototype/rb.rb#430
  def function_type_from_body(node, def_name); end

  # source://rbs//lib/rbs/prototype/rb.rb#504
  ...
  # source://rbs//lib/rbs/prototype/rb.rb#421
  def literal_to_symbol(node); end

  # source://rbs//lib/rbs/prototype/rb.rb#525
  def literal_to_type(node); end

  # backward compatible
  #
  # source://rbs//lib/rbs/prototype/rb.rb#646
  ...
  # source://rbs//lib/rbs/prototype/rb.rb#615
...
class RBS::Prototype::RBI
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/prototype/rbi.rb#546
  def call_node?(node, name:, receiver: T.unsafe(nil), args: T.unsafe(nil)); end

  # source://rbs//lib/rbs/prototype/rbi.rb#550
  def const_to_name(node); end
  ...
  # source://rbs//lib/rbs/prototype/rbi.rb#590
  ...
  # source://rbs//lib/rbs/prototype/rbi.rb#278
  ...
  # source://rbs//lib/rbs/prototype/rbi.rb#612
  def node_to_hash(node); end

  # source://rbs//lib/rbs/prototype/rbi.rb#16
  def parse(string); end

  # source://rbs//lib/rbs/prototype/rbi.rb#340
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/prototype/rbi.rb#538
  ...
  # source://rbs//lib/rbs/prototype/rbi.rb#461
  def type_of(type_node, variables:); end

  # source://rbs//lib/rbs/prototype/rbi.rb#474
...
class RBS::Prototype::Runtime
  ...
  # source://rbs//lib/rbs/prototype/runtime.rb#553
  ...
  #
  # source://rbs//lib/rbs/prototype/runtime.rb#491
  ...
  # source://rbs//lib/rbs/prototype/runtime.rb#387
  def generate_class(mod); end

  # source://rbs//lib/rbs/prototype/runtime.rb#336
  def generate_constants(mod, decls); end

  # source://rbs//lib/rbs/prototype/runtime.rb#228
  def generate_methods(mod, module_name, members); end

  # source://rbs//lib/rbs/prototype/runtime.rb#434
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/prototype/runtime.rb#217
  ...
  # source://rbs//lib/rbs/prototype/runtime.rb#545
...
# source://rbs//lib/rbs/errors.rb#95
class RBS::RecursiveAncestorError < ::RBS::DefinitionError
  ...
  #
  # source://rbs//lib/rbs/errors.rb#99
  ...
  # Returns the value of attribute location.
  #
  # source://rbs//lib/rbs/errors.rb#97
  def location; end
...
class RBS::Resolver::TypeNameResolver
  ...
  # source://rbs//lib/rbs/resolver/type_name_resolver.rb#26
  def resolve(type_name, context:); end

  # source://rbs//lib/rbs/resolver/type_name_resolver.rb#36
  def resolve_in(type_name, context); end

  # source://rbs//lib/rbs/resolver/type_name_resolver.rb#19
...
class RBS::Subtractor
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/subtractor.rb#117
  def cvar_exist?(owner, name); end

  # source://rbs//lib/rbs/subtractor.rb#126
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/subtractor.rb#105
  def ivar_exist?(owner, name, kind); end

  # @return [Boolean]
  #
  # source://rbs//lib/rbs/subtractor.rb#59
  def member_exist?(owner, member, context:); end

  # @return [Boolean]
  #
  # source://rbs//lib/rbs/subtractor.rb#88
  def method_exist?(owner, method_name, kind); end

  # @return [Boolean]
  #
  # source://rbs//lib/rbs/subtractor.rb#136
  def mixin_exist?(owner, mixin, context:); end

  # source://rbs//lib/rbs/subtractor.rb#169
  def typename_candidates(name, context:); end

  # source://rbs//lib/rbs/subtractor.rb#147
...
class RBS::Types::Block
  ...
  # source://rbs//lib/rbs/types.rb#1045
  def ==(other); end
  ...
  #
  # source://rbs//lib/rbs/types.rb#1036
  def required; end

  # Returns the value of attribute self_type.
  #
  # source://rbs//lib/rbs/types.rb#1037
  def self_type; end

  # source://rbs//lib/rbs/types.rb#1060
  def sub(s); end

  # source://rbs//lib/rbs/types.rb#1052
  def to_json(state = T.unsafe(nil)); end
...
class RBS::Types::Function
  ...
  # source://rbs//lib/rbs/types.rb#787
  def ==(other); end
  ...
  # source://rbs//lib/rbs/types.rb#1012
  def drop_tail; end
  ...
  # @return [Boolean]
  #
  # source://rbs//lib/rbs/types.rb#966
  def empty?; end
  ...
  #
  # source://rbs//lib/rbs/types.rb#768
  def optional_positionals; end

  # source://rbs//lib/rbs/types.rb#976
  def param_to_s; end
  ...
  #
  # source://rbs//lib/rbs/types.rb#767
  ...
  # source://rbs//lib/rbs/types.rb#991
  def return_to_s; end
...
class RBS::Types::Literal
  ...
  # source://rbs//lib/rbs/types.rb#1201
  def hash; end

  # Returns the value of attribute literal.
  #
  # source://rbs//lib/rbs/types.rb#1187
  def literal; end
  ...
  # source://rbs//lib/rbs/types.rb#1210
  def to_json(state = T.unsafe(nil)); end
...
class RBS::Types::Proc
  ...
  # source://rbs//lib/rbs/types.rb#1102
  def ==(other); end
  ...
  # Returns the value of attribute block.
  #
  # source://rbs//lib/rbs/types.rb#1091
  def block; end

  # source://rbs//lib/rbs/types.rb#1154
  def each_type(&block); end
  ...
  # source://rbs//lib/rbs/types.rb#1108
  def hash; end
  ...
  # source://rbs//lib/rbs/types.rb#1172
  def map_type(&block); end
  ...
  # Returns the value of attribute self_type.
  #
  # source://rbs//lib/rbs/types.rb#1092
  def self_type; end

  # source://rbs//lib/rbs/types.rb#1129
  def sub(s); end

  # source://rbs//lib/rbs/types.rb#1119
  def to_json(state = T.unsafe(nil)); end

  # source://rbs//lib/rbs/types.rb#1138
  def to_s(level = T.unsafe(nil)); end
...
# source://rbs//lib/rbs/errors.rb#310
class RBS::UnknownMethodAliasError < ::RBS::DefinitionError
  ...
  #
  # source://rbs//lib/rbs/errors.rb#318
  ...
  # Returns the value of attribute location.
  #
  # source://rbs//lib/rbs/errors.rb#316
  def location; end
...
class RBS::Validator
  ...
  # source://rbs//lib/rbs/validator.rb#60
  def validate_type_alias(entry:); end

  # source://rbs//lib/rbs/validator.rb#117
